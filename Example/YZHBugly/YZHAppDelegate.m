...
#define buglyAppId @"c128bad8c1"
#define buglyAppKey @"abbfa316-8392-4abf-bc3e-38bfd14feb55"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[YZHBuglyUtils shared] configBuglyWithAppId:buglyAppId AppKey:buglyAppKey];
    return YES;
}
